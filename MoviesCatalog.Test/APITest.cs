...
namespace MoviesCatalog.Test
{
    ...
    public class APITest
    {
        ...
        [TestMethod]
        public async Task PostRatings()
        {
            requestMessage = new HttpRequestMessage(HttpMethod.Post, "Ratings?id=2&rate=5");
            var response = await _httpClient.SendAsync(requestMessage);
        ...
        {
            NewUserView user = new NewUserView() {
            ...
            requestMessage = new HttpRequestMessage(HttpMethod.Post, ("Account/Register"));
            requestMessage.Content = stringContent;
            var postResponse = await _httpClient.SendAsync(requestMessage);
        ...
        [TestMethod]
        public async Task PostCreateMovie()
        {
            MovieView movie = new MovieView()
            {
                ...
                ReleaseYear = 2023,
                Categorie = "Action",
                Synapsis = "Test Movie generated by IA"
            };

            var json = JsonConvert.SerializeObject(movie);
            var stringContent = new StringContent(json.ToString(), Encoding.UTF8, "application/json");

            requestMessage = new HttpRequestMessage(HttpMethod.Post, ("Movies"));
            requestMessage.Content = stringContent;
            var postResponse = await _httpClient.SendAsync(requestMessage);
